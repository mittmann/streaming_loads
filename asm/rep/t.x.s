...
# options passed:  ../src/rep/t.x.c -mavx512vl -mtune=generic -march=x86-64
# -O0 -fverbose-asm
...
# ../src/rep/t.x.c:17: 		_mm512_store_si512(&mem[i], temp);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/avx512fintrin.h:580:   *(__m512i *) __P = __A;
	...
	vmovdqa64	%zmm0, (%rax)	# tmp96, MEM[(__m512i * {ref-all})__P_26]
...
# ../src/rep/t.x.c:21: 	int i = 0;
	movl	$0, 244(%rsp)	#, i
# ../src/rep/t.x.c:23: 		local = _mm512_stream_load_si512(&mem[i]);
