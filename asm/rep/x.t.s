...
# options passed:  ../src/rep/x.t.c -mavx512vl -mtune=generic -march=x86-64
# -O0 -fverbose-asm
...
# ../src/rep/x.t.c:10: 	unsigned long long int acc = 0;
	movq	$0, 256(%rsp)	#, acc
# ../src/rep/x.t.c:12:     for(int j=0; j<REP; j++){ 
	movl	$0, 252(%rsp)	#, j
# ../src/rep/x.t.c:12:     for(int j=0; j<REP; j++){ 
	jmp	.L2	#
.L6:
# ../src/rep/x.t.c:13: 	int i=0;
	movl	$0, 244(%rsp)	#, i
# ../src/rep/x.t.c:15: 		temp[0]=i;
	movl	244(%rsp), %eax	# i, tmp91
	cltq
	movq	%rax, -56(%rsp)	# _1, temp
# ../src/rep/x.t.c:16: 		_mm512_stream_si512(&mem[i], temp);
	vmovdqa64	-56(%rsp), %zmm0	# temp, temp.0_2
	movl	244(%rsp), %eax	# i, tmp93
	cltq
	salq	$6, %rax	#, tmp94
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/emmintrin.h:1511: }
	nop	
# ../src/rep/x.t.c:19: 	for(int i=0; i < ARRAY_SIZE; i++)
	movl	$0, 248(%rsp)	#, i
# ../src/rep/x.t.c:19: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L3	#
.L5:
# ../src/rep/x.t.c:21: 		local = _mm512_load_si512(&mem[i]);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/avx512fintrin.h:547:   return *(__m512i *) __P;
	...
	vmovdqa64	(%rax), %zmm0	# MEM[(__m512i * {ref-all})__P_29], D.24076
# ../src/rep/x.t.c:21: 		local = _mm512_load_si512(&mem[i]);
	vmovdqa64	%zmm0, 8(%rsp)	# D.24076, local
# ../src/rep/x.t.c:22: 		acc += *((uint64_t*)&local);
...
# ../src/rep/x.t.c:12:     for(int j=0; j<REP; j++){ 
	cmpl	$999, 252(%rsp)	#, j
	jle	.L6	#,
# ../src/rep/x.t.c:26: 	return (int)acc;
