...
# options passed:  ../src/rep/n.n.c -mavx512vl -mtune=generic -march=x86-64
# -O0 -fverbose-asm
...
# ../src/rep/n.n.c:16: 		_mm512_stream_si512(&mem[i], temp);
...
# ../src/rep/n.n.c:20: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L5	#
.L7:
# ../src/rep/n.n.c:22: 		local = _mm512_stream_load_si512(&mem[i]);
