...
# options passed:  ../src/one/n.t.f.c -mavx512vl -mtune=generic
...
# ../src/one/n.t.f.c:10: 	unsigned long long int acc = 0;
	movq	$0, 256(%rsp)	#, acc
# ../src/one/n.t.f.c:12: 	for(int i=0; i<ARRAY_SIZE; i++)
	movl	$0, 252(%rsp)	#, i
# ../src/one/n.t.f.c:12: 	for(int i=0; i<ARRAY_SIZE; i++)
	jmp	.L2	#
.L3:
# ../src/one/n.t.f.c:15: 		temp[0]=i;
	movl	252(%rsp), %eax	# i, tmp91
	cltq
	movq	%rax, -56(%rsp)	# _1, temp
# ../src/one/n.t.f.c:16: 		_mm512_stream_si512(&mem[i], temp);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/emmintrin.h:1511: }
	nop	
# ../src/one/n.t.f.c:24: 	for(int i=0; i < ARRAY_SIZE; i++)
	movl	$0, 248(%rsp)	#, i
# ../src/one/n.t.f.c:24: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L4	#
.L6:
# ../src/one/n.t.f.c:26: 		local = _mm512_load_si512(&mem[i]);
...
# ../src/one/n.t.f.c:27: 		acc += *((uint64_t*)&local);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/emmintrin.h:1511: }
	nop	
# ../src/one/n.t.f.c:31: 	return (int)acc;
