...
# options passed:  ../src/rep/n.n.c -mavx2 -mtune=generic -march=x86-64 -O0
# -fverbose-asm
...
# ../src/rep/n.n.c:10: 	unsigned long long int acc = 0;
	movq	$0, 64(%rsp)	#, acc
# ../src/rep/n.n.c:11:     for(int j=0; j<REP; j++){	
	movl	$0, 60(%rsp)	#, j
# ../src/rep/n.n.c:11:     for(int j=0; j<REP; j++){	
	jmp	.L2	#
.L8:
# ../src/rep/n.n.c:12: 	for(int i=0; i<ARRAY_SIZE; i++)
	movl	$0, 56(%rsp)	#, i
# ../src/rep/n.n.c:12: 	for(int i=0; i<ARRAY_SIZE; i++)
	jmp	.L3	#
.L4:
# ../src/rep/n.n.c:15: 		temp[0]=i;
	movl	56(%rsp), %eax	# i, tmp91
	cltq
	movq	%rax, -88(%rsp)	# _1, temp
# ../src/rep/n.n.c:16: 		_mm256_stream_si256(&mem[i], temp);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/emmintrin.h:1511: }
	nop	
# ../src/rep/n.n.c:20: 	for(int i=0; i < ARRAY_SIZE; i++)
	movl	$0, 52(%rsp)	#, i
# ../src/rep/n.n.c:20: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L5	#
.L7:
# ../src/rep/n.n.c:22: 		local = _mm256_stream_load_si256(&mem[i]);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/avx2intrin.h:922:   return (__m256i) __builtin_ia32_movntdqa256 ((__v4di *) __X);
	...
	vmovntdqa	(%rax), %ymm0	#, D.24079
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/avx2intrin.h:922:   return (__m256i) __builtin_ia32_movntdqa256 ((__v4di *) __X);
	nop	
# ../src/rep/n.n.c:22: 		local = _mm256_stream_load_si256(&mem[i]);
	vmovdqa	%ymm0, -56(%rsp)	# D.24079, local
# ../src/rep/n.n.c:23: 		acc += *((uint64_t*)&local);
...
# ../src/rep/n.n.c:11:     for(int j=0; j<REP; j++){	
	cmpl	$999, 60(%rsp)	#, j
	jle	.L8	#,
# ../src/rep/n.n.c:28: 	return (int)acc;
