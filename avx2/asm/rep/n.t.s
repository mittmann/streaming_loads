...
# options passed:  ../src/rep/n.t.c -mavx2 -mtune=generic -march=x86-64 -O0
# -fverbose-asm
...
# ../src/rep/n.t.c:16: 		_mm256_stream_si256(&mem[i], temp);
...
# ../src/rep/n.t.c:20: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L5	#
.L7:
# ../src/rep/n.t.c:22: 		local = _mm256_load_si256(&mem[i]);
