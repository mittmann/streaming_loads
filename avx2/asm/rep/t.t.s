...
# options passed:  ../src/rep/t.t.c -mavx2 -mtune=generic -march=x86-64 -O0
# -fverbose-asm
...
# ../src/rep/t.t.c:22: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L5	#
.L7:
# ../src/rep/t.t.c:24: 		local = _mm256_load_si256(&mem[i]);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/avxintrin.h:910:   return *__P;
	...
	vmovdqa	(%rax), %ymm0	# *__P_32, D.24079
# ../src/rep/t.t.c:24: 		local = _mm256_load_si256(&mem[i]);
	vmovdqa	%ymm0, -56(%rsp)	# D.24079, local
