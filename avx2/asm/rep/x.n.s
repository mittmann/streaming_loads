...
# options passed:  ../src/rep/x.n.c -mavx2 -mtune=generic -march=x86-64 -O0
# -fverbose-asm
...
# ../src/rep/x.n.c:15: 		temp[0]=i;
	movl	52(%rsp), %eax	# i, tmp91
	cltq
	movq	%rax, -88(%rsp)	# _1, temp
# ../src/rep/x.n.c:16: 		_mm256_stream_si256(&mem[i], temp);
	vmovdqa	-88(%rsp), %ymm0	# temp, temp.0_2
	movl	52(%rsp), %eax	# i, tmp93
	cltq
	salq	$5, %rax	#, tmp94
...
# ../src/rep/x.n.c:21: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L3	#
.L5:
# ../src/rep/x.n.c:23: 		local = _mm256_stream_load_si256(&mem[i]);
