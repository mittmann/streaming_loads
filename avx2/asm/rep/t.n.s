...
# options passed:  ../src/rep/t.n.c -mavx2 -mtune=generic -march=x86-64 -O0
# -fverbose-asm
...
# ../src/rep/t.n.c:17: 		_mm256_store_si256(&mem[i], temp);
...
# ../src/rep/t.n.c:21: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L5	#
.L7:
# ../src/rep/t.n.c:23: 		local = _mm256_stream_load_si256(&mem[i]);
