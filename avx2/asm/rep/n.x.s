...
# options passed:  ../src/rep/n.x.c -mavx2 -mtune=generic -march=x86-64 -O0
# -fverbose-asm
...
# ../src/rep/n.x.c:17: 		_mm256_stream_si256(&mem[i], temp);
...
# ../src/rep/n.x.c:21: 	int i = 0;
	movl	$0, 52(%rsp)	#, i
# ../src/rep/n.x.c:23: 		local = _mm256_stream_load_si256(&mem[i]);
