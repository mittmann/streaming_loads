...
# options passed:  ../src/rep/t.t.f.c -mavx2 -mtune=generic -march=x86-64
# -O0 -fverbose-asm
...
# ../src/rep/t.t.f.c:17: 		_mm256_store_si256(&mem[i], temp);
...
# ../src/rep/t.t.f.c:23: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L5	#
.L7:
# ../src/rep/t.t.f.c:25: 		local = _mm256_load_si256(&mem[i]);
