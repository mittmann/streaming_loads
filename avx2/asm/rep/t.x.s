...
# options passed:  ../src/rep/t.x.c -mavx2 -mtune=generic -march=x86-64 -O0
# -fverbose-asm
...
# ../src/rep/t.x.c:10: 	unsigned long long int acc = 0;
	movq	$0, 64(%rsp)	#, acc
# ../src/rep/t.x.c:12:     for(int j=0; j<REP; j++){ 	
	movl	$0, 60(%rsp)	#, j
# ../src/rep/t.x.c:12:     for(int j=0; j<REP; j++){ 	
	jmp	.L2	#
.L6:
# ../src/rep/t.x.c:13: 	for(int i=0; i<ARRAY_SIZE; i++)
	movl	$0, 56(%rsp)	#, i
# ../src/rep/t.x.c:13: 	for(int i=0; i<ARRAY_SIZE; i++)
	jmp	.L3	#
.L4:
# ../src/rep/t.x.c:16: 		temp[0]=i;
	movl	56(%rsp), %eax	# i, tmp91
	cltq
	movq	%rax, -88(%rsp)	# _1, temp
# ../src/rep/t.x.c:17: 		_mm256_store_si256(&mem[i], temp);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/emmintrin.h:1511: }
	nop	
# ../src/rep/t.x.c:21: 	int i = 0;
	movl	$0, 52(%rsp)	#, i
# ../src/rep/t.x.c:23: 		local = _mm256_stream_load_si256(&mem[i]);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/avx2intrin.h:922:   return (__m256i) __builtin_ia32_movntdqa256 ((__v4di *) __X);
	...
	vmovntdqa	(%rax), %ymm0	#, D.24076
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/avx2intrin.h:922:   return (__m256i) __builtin_ia32_movntdqa256 ((__v4di *) __X);
	nop	
# ../src/rep/t.x.c:23: 		local = _mm256_stream_load_si256(&mem[i]);
	vmovdqa	%ymm0, -56(%rsp)	# D.24076, local
# ../src/rep/t.x.c:24: 		acc += *((uint64_t*)&local);
...
# ../src/rep/t.x.c:12:     for(int j=0; j<REP; j++){ 	
	cmpl	$999, 60(%rsp)	#, j
	jle	.L6	#,
# ../src/rep/t.x.c:28: 	return (int)acc;
