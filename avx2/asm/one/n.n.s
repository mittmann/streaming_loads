...
# options passed:  ../src/one/n.n.c -mavx2 -mtune=generic -march=x86-64 -O0
# -fverbose-asm
...
# ../src/one/n.n.c:16: 		_mm256_stream_si256(&mem[i], temp);
...
# ../src/one/n.n.c:20: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L4	#
.L6:
# ../src/one/n.n.c:22: 		local = _mm256_stream_load_si256(&mem[i]);
