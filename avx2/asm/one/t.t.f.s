...
# options passed:  ../src/one/t.t.f.c -mavx2 -mtune=generic -march=x86-64
# -O0 -fverbose-asm
...
# ../src/one/t.t.f.c:16: 		_mm256_store_si256(&mem[i], temp);
...
# ../src/one/t.t.f.c:23: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L4	#
.L6:
# ../src/one/t.t.f.c:25: 		local = _mm256_load_si256(&mem[i]);
