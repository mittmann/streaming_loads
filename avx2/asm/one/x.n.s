...
# options passed:  ../src/one/x.n.c -mavx2 -mtune=generic -march=x86-64 -O0
# -fverbose-asm
...
# ../src/one/x.n.c:15: 		_mm256_stream_si256(&mem[i], temp);
...
# ../src/one/x.n.c:20: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L2	#
.L4:
# ../src/one/x.n.c:22: 		local = _mm256_stream_load_si256(&mem[i]);
