...
# options passed:  ../src/one/n.t.c -mavx2 -mtune=generic -march=x86-64 -O0
# -fverbose-asm
...
# ../src/one/n.t.c:16: 		_mm256_stream_si256(&mem[i], temp);
...
# ../src/one/n.t.c:20: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L4	#
.L6:
# ../src/one/n.t.c:22: 		local = _mm256_load_si256(&mem[i]);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/avxintrin.h:910:   return *__P;
	...
	vmovdqa	(%rax), %ymm0	# *__P_27, D.24075
# ../src/one/n.t.c:22: 		local = _mm256_load_si256(&mem[i]);
