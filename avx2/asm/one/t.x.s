...
# options passed:  ../src/one/t.x.c -mavx2 -mtune=generic -march=x86-64 -O0
# -fverbose-asm
...
# ../src/one/t.x.c:16: 		_mm256_store_si256(&mem[i], temp);
...
# ../src/one/t.x.c:20: 	int i = 0;
	movl	$0, 52(%rsp)	#, i
# ../src/one/t.x.c:22: 		local = _mm256_stream_load_si256(&mem[i]);
