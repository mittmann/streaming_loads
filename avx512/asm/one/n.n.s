...
# options passed:  ../src/one/n.n.c -mavx512vl -mtune=generic -march=x86-64
# -O0 -fverbose-asm
...
# ../src/one/n.n.c:10: 	unsigned long long int acc = 0;
	movq	$0, 256(%rsp)	#, acc
# ../src/one/n.n.c:12: 	for(int i=0; i<ARRAY_SIZE; i++)
	movl	$0, 252(%rsp)	#, i
# ../src/one/n.n.c:12: 	for(int i=0; i<ARRAY_SIZE; i++)
	jmp	.L2	#
.L3:
# ../src/one/n.n.c:15: 		temp[0]=i;
	movl	252(%rsp), %eax	# i, tmp91
	cltq
	movq	%rax, -56(%rsp)	# _1, temp
# ../src/one/n.n.c:16: 		_mm512_stream_si512(&mem[i], temp);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/emmintrin.h:1511: }
	nop	
# ../src/one/n.n.c:20: 	for(int i=0; i < ARRAY_SIZE; i++)
	movl	$0, 248(%rsp)	#, i
# ../src/one/n.n.c:20: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L4	#
.L6:
# ../src/one/n.n.c:22: 		local = _mm512_stream_load_si512(&mem[i]);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/avx512fintrin.h:8654:   return __builtin_ia32_movntdqa512 ((__v8di *)__P);
	...
	vmovntdqa	(%rax), %zmm0	#, D.24075
# ../src/one/n.n.c:22: 		local = _mm512_stream_load_si512(&mem[i]);
	vmovdqa64	%zmm0, 8(%rsp)	# D.24075, local
# ../src/one/n.n.c:23: 		acc += *((uint64_t*)&local);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/emmintrin.h:1511: }
	nop	
# ../src/one/n.n.c:28: 	return (int)acc;
