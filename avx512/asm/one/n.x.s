...
# options passed:  ../src/one/n.x.c -mavx512vl -mtune=generic -march=x86-64
# -O0 -fverbose-asm
...
# ../src/one/n.x.c:16: 		_mm512_stream_si512(&mem[i], temp);
...
# ../src/one/n.x.c:20: 	int i = 0;
	movl	$0, 244(%rsp)	#, i
# ../src/one/n.x.c:22: 		local = _mm512_stream_load_si512(&mem[i]);
