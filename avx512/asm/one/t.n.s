...
# options passed:  ../src/one/t.n.c -mavx512vl -mtune=generic -march=x86-64
# -O0 -fverbose-asm
...
# ../src/one/t.n.c:16: 		_mm512_store_si512(&mem[i], temp);
...
# ../src/one/t.n.c:20: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L4	#
.L6:
# ../src/one/t.n.c:22: 		local = _mm512_stream_load_si512(&mem[i]);
