...
# options passed:  ../src/rep/t.t.f.c -mavx512vl -mtune=generic
...
# ../src/rep/t.t.f.c:10: 	unsigned long long int acc = 0;
	movq	$0, 256(%rsp)	#, acc
# ../src/rep/t.t.f.c:12:     for(int j=0; j<REP; j++){ 	
	movl	$0, 252(%rsp)	#, j
# ../src/rep/t.t.f.c:12:     for(int j=0; j<REP; j++){ 	
	jmp	.L2	#
.L8:
# ../src/rep/t.t.f.c:13: 	for(int i=0; i<ARRAY_SIZE; i++)
	movl	$0, 248(%rsp)	#, i
# ../src/rep/t.t.f.c:13: 	for(int i=0; i<ARRAY_SIZE; i++)
	jmp	.L3	#
.L4:
# ../src/rep/t.t.f.c:16: 		temp[0]=i;
	movl	248(%rsp), %eax	# i, tmp91
	cltq
	movq	%rax, -56(%rsp)	# _1, temp
# ../src/rep/t.t.f.c:17: 		_mm512_store_si512(&mem[i], temp);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/emmintrin.h:1511: }
	nop	
# ../src/rep/t.t.f.c:23: 	for(int i=0; i < ARRAY_SIZE; i++)
	movl	$0, 244(%rsp)	#, i
# ../src/rep/t.t.f.c:23: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L5	#
.L7:
# ../src/rep/t.t.f.c:25: 		local = _mm512_load_si512(&mem[i]);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/avx512fintrin.h:547:   return *(__m512i *) __P;
	...
	vmovdqa64	(%rax), %zmm0	# MEM[(__m512i * {ref-all})__P_32], D.24080
# ../src/rep/t.t.f.c:25: 		local = _mm512_load_si512(&mem[i]);
	vmovdqa64	%zmm0, 8(%rsp)	# D.24080, local
# ../src/rep/t.t.f.c:26: 		acc += *((uint64_t*)&local);
...
# ../src/rep/t.t.f.c:12:     for(int j=0; j<REP; j++){ 	
	cmpl	$999, 252(%rsp)	#, j
	jle	.L8	#,
# ../src/rep/t.t.f.c:33: 	return (int)acc;
