...
# options passed:  ../src/rep/n.t.c -mavx512vl -mtune=generic -march=x86-64
# -O0 -fverbose-asm
...
# ../src/rep/n.t.c:10: 	unsigned long long int acc = 0;
	movq	$0, 256(%rsp)	#, acc
# ../src/rep/n.t.c:11:     for(int j=0; j<REP; j++){ 	
	movl	$0, 252(%rsp)	#, j
# ../src/rep/n.t.c:11:     for(int j=0; j<REP; j++){ 	
	jmp	.L2	#
.L8:
# ../src/rep/n.t.c:12: 	for(int i=0; i<ARRAY_SIZE; i++)
	movl	$0, 248(%rsp)	#, i
# ../src/rep/n.t.c:12: 	for(int i=0; i<ARRAY_SIZE; i++)
	jmp	.L3	#
.L4:
# ../src/rep/n.t.c:15: 		temp[0]=i;
	movl	248(%rsp), %eax	# i, tmp91
	cltq
	movq	%rax, -56(%rsp)	# _1, temp
# ../src/rep/n.t.c:16: 		_mm512_stream_si512(&mem[i], temp);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/emmintrin.h:1511: }
	nop	
# ../src/rep/n.t.c:20: 	for(int i=0; i < ARRAY_SIZE; i++)
	movl	$0, 244(%rsp)	#, i
# ../src/rep/n.t.c:20: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L5	#
.L7:
# ../src/rep/n.t.c:22: 		local = _mm512_load_si512(&mem[i]);
...
# /usr/local/gcc-9.3/lib/gcc/x86_64-linux-gnu/9.3.0/include/avx512fintrin.h:547:   return *(__m512i *) __P;
	...
	vmovdqa64	(%rax), %zmm0	# MEM[(__m512i * {ref-all})__P_32], D.24079
# ../src/rep/n.t.c:22: 		local = _mm512_load_si512(&mem[i]);
	vmovdqa64	%zmm0, 8(%rsp)	# D.24079, local
# ../src/rep/n.t.c:23: 		acc += *((uint64_t*)&local);
...
# ../src/rep/n.t.c:11:     for(int j=0; j<REP; j++){ 	
	cmpl	$999, 252(%rsp)	#, j
	jle	.L8	#,
# ../src/rep/n.t.c:27: 	return (int)acc;
