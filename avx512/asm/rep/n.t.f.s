...
# options passed:  ../src/rep/n.t.f.c -mavx512vl -mtune=generic
...
# ../src/rep/n.t.f.c:16: 		_mm512_stream_si512(&mem[i], temp);
...
# ../src/rep/n.t.f.c:22: 	for(int i=0; i < ARRAY_SIZE; i++)
	jmp	.L5	#
.L7:
# ../src/rep/n.t.f.c:24: 		local = _mm512_load_si512(&mem[i]);
